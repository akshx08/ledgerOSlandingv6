  ...
  return (
    <>
      ...
      <main className="relative z-content">
        ...
        <section className="relative bg-vermilion py-16 text-porcelain md:py-20">
          <div className="mx-auto max-w-[110rem] px-5 md:px-10">
            <p className="wide max-w-[16ch] text-d3">{DRENCH.lead}</p>
          </div>
          <div className="my-9 border-y border-porcelain/30 py-5">
        ...
        <section className="border-t rule bg-porcelain px-5 py-20 md:px-10 md:py-28">
