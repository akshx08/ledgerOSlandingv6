...
/** the drive begins while debris is still in the air */
const ENTER_START = 1.75;
/** and the camera has arrived — and the page with it — by here */
const ENTER_END = 2.55;
